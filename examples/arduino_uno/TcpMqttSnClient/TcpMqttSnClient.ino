...
const char* clientId = "TcpMqttSnClient";
char* subscribeTopicName = "Uno/Ethernet/Tcp/subscribe";
char* publishTopicName = "Uno/Ethernet/Tcp/publish";
...
void loop() {
  if (!mqttSnClient.is_mqttsn_connected()) {
    ...
    convertIPAddressAndPortToDeviceAddress(gatewayIPAddress, localTcpPort, gateway_device_address);
