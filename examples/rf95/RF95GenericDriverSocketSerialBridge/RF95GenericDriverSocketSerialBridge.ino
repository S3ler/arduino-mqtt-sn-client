...
TransmissionProtocolUartBridge <RHGenericDriverSocket> transmissionProtocolUartBridge(&Serial, rhGenericDriverSocket);
...
void setup() {
  ...
  // Wait for Console por t to connect
  while (!Serial) {}
  ...
  Serial.println("RF95GenericDriverSocketSerialBridge v0.1 ready!");
}
